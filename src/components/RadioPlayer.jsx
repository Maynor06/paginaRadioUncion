  ...
  return (
    <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-auto border border-gray-100" transition:persist>
      <div className="flex items-center justify-between mb-4">
        ...
        {isLive && (
          <span className="flex items-center gap-1 bg-red-100 text-red-600 px-2 py-1 rounded-full text-xs font-bold animate-pulse">
      ...
      <div className="flex flex-col gap-4">
        ...
        <button
          onClick={togglePlay}
          className={`w-full py-4 rounded-xl flex items-center justify-center gap-3 transition-all transform hover:scale-105 ${
            isPlaying 
